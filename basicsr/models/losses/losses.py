...
class CharbonnierLoss(nn.Module):
    ...
    def __init__(self, loss_weight=1.0, reduction='mean', regular_weight=0.1,eps=1e-12):
    ...
    def forward(self, pred, target, weight=None, **kwargs):
        ...
        """
        # ipdb.set_trace()
        # ret = self.loss_weight * charbonnier_loss(pred[0], target, weight, eps=self.eps, reduction=self.reduction)+\
        #     self.loss_weight * self.regular_weight * charbonnier_loss(pred[2][:,0,...], pred[2][:,1,...], weight, eps=self.eps, reduction=self.reduction)
